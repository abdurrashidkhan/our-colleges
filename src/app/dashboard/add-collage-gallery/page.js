...
import insertCollegeGallery from "@/database/insert/insertCollegeGallery";
import { useEffect, useState } from "react";
import { useAuthState, useSignOut } from "react-firebase-hooks/auth";
import { useForm } from "react-hook-form";
export default function AddCollageGalley() {
    ...
    fetch(url, {
      ...
      .then((result) => {
        if (result.success) {
          ...
          const insertProjects = insertCollegeGallery(
            collegeGallery,
            seIsLoading,
            reset
          );
